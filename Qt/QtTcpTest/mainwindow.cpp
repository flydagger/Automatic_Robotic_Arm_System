 ...
 * "6": From PR, check if the target object is in the valid working area.
...
//    QThread::sleep (1);
    ...
    case 4 : //QMessageBox::warning (this, "Notification", "Finished moving to object. Redetect the object.");
             sendSockPR ("9");  // Received "4" from RC. Send "9" to PR to redetect the object.
             break;
...
//             sendSockPR ("9");
             // require the RC to check valid working area.
             sendSockRC (command);
             break;
    ...
    case 50: // Received 'b' from RC, which means it is time to release component.
             ...
             sendSockRC("1");
             break;
    case 51: // Received 'c' from RC, containing the result of checking valid working area.
             sendSockPR (command);
             break;
    default: break;
    }
